...
soilData = pd.read_csv('Test_data/Wetting2.csv')
...
# 17. Calculate the prediction by DNN models 
...
print(predicted_SWC)
predicted_SWC.to_csv('./Output_files/DNN_Layer5_predicted_Wetting2_SWC_Epoch=5000.csv', encoding='utf-8', index=False)
...
plt.tight_layout()
# 20. Saave the plots
plt.savefig('./Output_files/NeuralNetwork_Wetting2_SWC_5Hidden-Layers_Epoch=5000.png', bbox_inches="tight")
plt.savefig('./Output_files/NeuralNetwork_Wetting2_SWC_5Hidden-Layers_Epoch=5000.pdf', bbox_inches="tight")
plt.show()
